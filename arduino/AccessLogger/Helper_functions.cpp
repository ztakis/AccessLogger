...
void printCardUID() {                               // Print card's UID to serial & log file
  ...
  for (uint8_t i = 0; i < 4; i++) {
    ...
    client.print(scannedID[i] < 0x10 ? "0" : "");
    client.print(scannedID[i], HEX);
  }
  logfile.print(",");
  Serial.println();
  client.print("&data=");
...
void printDateTime() {                              // Print date & time to web & log file & serial
  DateTime now = rtc.now();

  client.print(now.unixtime());
  client.print("&data=");
  ...
  client.print("%20");
  client.print(now.hour() < 10 ? "0" : "");
  client.print(now.hour(), DEC);
  client.print(":");
  client.print(now.minute() < 10 ? "0" : "");
  client.print(now.minute(), DEC);
  client.print(":");
  client.print(now.second() < 10 ? "0" : "");
...
void printUser() {                                  // Print card's personal data to lcd & serial & log file & web
  lcd.clear();
  lcd.setCursor(0, 0);
  Serial.print(F("Name: "));
